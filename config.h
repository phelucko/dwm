...
static char selbordercolor[]        = "#3F8AC2";
...
const char *spcmd1[] = {"st", "-A", "1", "-n", "spterm", "-g", "120x34", "-e", "tmux_archpad", NULL };
const char *spcmd2[] = {"st", "-A", "1", "-n", "spcalc", "-f", "monospace:size=20", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "libreoffice-startcenter",  NULL,         NULL,       	    1 << 4,         1,            0,           0,         0,        -1 },
	{ "VirtualBox Manager",       NULL,         NULL,       	    1 << 5,         1,            0,           0,         0,        -1 },
	{ "VirtualBox Machine",       NULL,         NULL,       	    1 << 5,         1,            0,           0,         0,        -1 },
	{ "rdesktop",                 NULL,         NULL,       	    1 << 5,         1,            0,           0,         0,        -1 },
	{ "SAP GUI for Java",         NULL,         NULL,       	    1 << 6,         1,            0,           0,         0,        -1 },
	{ "Signal",                   NULL,         NULL,       	    1 << 7,         1,            0,           0,         0,        -1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_d,		        spawn,		      SHCMD("dmenubuku") },
	{ MODKEY,			        XK_f,		        togglefullscr,	{0} },
	{ MODKEY|ShiftMask,		XK_f,		        setlayout,	    {.v = &layouts[8]} },
	{ MODKEY,			        XK_g,		        spawn,		      SHCMD("$TERMINAL -e nvim $XDG_DATA_HOME/wiki/kb/index.md") },
	{ MODKEY|ShiftMask,		XK_g,		        spawn,		      SHCMD("$TERMINAL -e nvim $XDG_DATA_HOME/wiki/personal/index.md") },
	...
	{ MODKEY,			        XK_c,		        spawn,		      SHCMD("dmenuconnect") },
	{ MODKEY,			        XK_b,		        togglebar,	    {0} },
	{ MODKEY,			        XK_n,		        spawn,		      SHCMD("$TERMINAL -e ncmpcpp") },
	{ MODKEY|ShiftMask,		XK_n,		        spawn,		      SHCMD("$TERMINAL -e newsboat; pkill -RTMIN+6 dwmblocks") },
	/* m is automatically bound above in STACKKEYS */
	{ MODKEY|ShiftMask,		XK_m,		        spawn,	        SHCMD("mpc toggle") },
	...
	{ MODKEY,			        XK_F8,		spawn,		      SHCMD("$HOME/.config/mutt/scripts/mailsync") },
